...
import {
  ...
  type TightenerOutput,
  type TightenerResult,
...
export class Orchestrator {
  ...
  private async handleDirectionRow(
    ...
    const { runDecisionCapture } = await import("@devplusllc/harness-core");
    try {
