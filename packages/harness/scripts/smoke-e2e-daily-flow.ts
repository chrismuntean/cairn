...
const SESSION_START_BIN = join(REPO_ROOT_PROJECT, "packages", "harness-core", "dist", "hooks", "session-start.js");
const STOP_BIN = join(REPO_ROOT_PROJECT, "packages", "harness-core", "dist", "hooks", "stop.js");
